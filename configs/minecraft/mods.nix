...
let
  ...
  inherit (helpers) fetchFromModrinth;
in
{
  latest = {
    default = {
      fabric-api = fetchFromModrinth {
        slug = "fabric-api";
        version = "0.146.1+26.1.2";
        sha256 = "sha256-8Jy/xmxRtw4z4GJ+38wwbXHVn4NGYp4w/mFvW9cmvKg=";
      };
      ferrite-core = fetchFromModrinth {
        slug = "ferrite-core";
        version = "9.0.0-fabric";
        sha256 = "sha256-ITlmxy7ZZ6zHOSvrKKhm+6MB/1a5l2wueAHC233mvyI=";
      };
      lithium = fetchFromModrinth {
        slug = "lithium";
        version = "mc26.1.2-0.24.2-fabric";
        sha256 = "sha256-IlKJ8aLw4nSbNl9lpJwD6o9FJEXkmJmVEME8s5ndTgA=";
      };
      no-chat-reports = fetchFromModrinth {
        slug = "no-chat-reports";
        version = "Fabric-26.1-v2.19.0";
        sha256 = "sha256-sySe6xxj3VDAF6e14DnuhMn2hbfQ3a57PrRqhzWlN7Q=";
      };
      scalable-lux = fetchFromModrinth {
        slug = "scalablelux";
    ...
    building = {
      axiom = fetchFromModrinth {
        slug = "axiom";
        version = "FR24mVMv";
        sha256 = "sha256-z38Ysp3my1vXjy7v+JgVc9VRbQWdqLEZ44HLVgCDxCQ=";
      };
      world-edit = fetchFromModrinth {
        slug = "worldedit";
        version = "7.4.3-beta-01";
        sha256 = "sha256-TBAEmah8pTKhUTXNg0nmvcxmSY4f8a3j344zLN+Vzqo=";
      };
    };

    macaws-furniture = fetchFromModrinth {
      slug = "macaws-furniture";
      version = "RZnGeGr0";
      sha256 = "sha256-9KJFniFn1nF0sgR/QWas/uM6LA5BAM5yESLh09ixq5s=";
    };

    motion-capture = fetchFromModrinth {
      slug = "motion-capture";
      version = "1.3.10-fabric-26.1";
      sha256 = "sha256-RIjC5A/SLiNloYsmvUk94A+i5CCJHbVK9qDXTayL3G8=";
    };
  };
